...
class UserRepository @Inject()(dbConfigProvider: DatabaseConfigProvider)(implicit ec: ExecutionContext) {
  ...
  class  UserTable(tag: Tag) extends Table[User](tag, "user") {
    ...
    def registeredAt = column[Date]("registeredAt")
    def lastLogin = column[Date]("lastLogin")
  ...
  def create(nick: String, firstName: String, lastName: String, email: String, password: String, registeredAt: Date, lastLogin: Date): Future[User] = db.run {
